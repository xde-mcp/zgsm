...
describe("ProviderSettingsManager", () => {
	...
	describe("SaveConfig", () => {
		it("should save new config", async () => {
			...
			expect(mockSecrets.store.mock.calls[0][0]).toEqual("costrict_config_api_config")
	...
	describe("ResetAllConfigs", () => {
		it("should delete all stored configs", async () => {
			...
			expect(mockSecrets.delete).toHaveBeenCalledWith("costrict_config_api_config")
		})
	})
